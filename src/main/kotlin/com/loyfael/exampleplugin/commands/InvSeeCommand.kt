 ...
 * Usage: /invsee <player>
 * Permission: loyfael.exampleplugin.command.invsee (auto-generated, view only)
 * Permission: loyfael.exampleplugin.command.invsee.modify (required to move items)
 */
class InvSeeCommand : AbstractPlayerCommand("invsee", "exampleplugin.commands.invsee.description") {

    companion object {
        private const val PERMISSION_MODIFY = "loyfael.exampleplugin.command.invsee.modify"
    }
