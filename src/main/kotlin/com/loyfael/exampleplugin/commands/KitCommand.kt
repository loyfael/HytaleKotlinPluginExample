 ...
 * Usage: /kit <name>
 * Permission: loyfael.exampleplugin.command.kit (auto-generated base permission)
 * Permission: loyfael.exampleplugin.command.kit.<kitname> (required for each specific kit)
 */
class KitCommand : AbstractPlayerCommand("kit", "exampleplugin.commands.kit.description") {

    companion object {
        private const val PERMISSION_BASE = "loyfael.exampleplugin.command.kit"
    }
