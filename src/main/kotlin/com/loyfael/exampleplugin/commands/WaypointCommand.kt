 ...
 * Usage: /waypoint <name>
 * Permission: loyfael.exampleplugin.command.waypoint (auto-generated base permission)
 * Permission: loyfael.exampleplugin.waypoint.<name> (required for each specific waypoint)
 */
class WaypointCommand : AbstractPlayerCommand("waypoint", "exampleplugin.commands.waypoint.description") {

    companion object {
        private const val PERMISSION_BASE = "loyfael.exampleplugin.waypoint"
    }
